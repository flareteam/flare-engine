...
extern std::string PATH_DEFAULT_DATA; // similar to PATH_DATA, except points to the "default" game
extern std::string PATH_DEFAULT_USER; // similar to PATH_USER, except points to the "default" game
