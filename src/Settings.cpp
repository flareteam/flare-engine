	...
	, safe_video(false)
{
	...
	setConfigDefault(15, "enable_joystick",     &typeid(enable_joystick),     "1",            &enable_joystick,     "Joystick settings.");
	setConfigDefault(16, "joystick_device",     &typeid(joystick_device),     "0",            &joystick_device,     "");
