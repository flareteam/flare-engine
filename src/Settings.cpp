	...
	, soft_reset(false)
{
	...
	setConfigDefault(37, "low_hp_warning_msg", &typeid(low_hp_warning_msg), "0",            &low_hp_warning_msg, "display message on low health. 1 enable, 0 disable.");
	setConfigDefault(38, "low_hp_warning_cur", &typeid(low_hp_warning_cur), "0",            &low_hp_warning_cur, "change cursor on low health. 1 enable, 0 disable.");
	setConfigDefault(39, "low_hp_warning_snd", &typeid(low_hp_warning_snd), "0",            &low_hp_warning_snd, "play sound on low health. 1 enable, 0 disable.");
	setConfigDefault(40, "low_hp_threshold",   &typeid(low_hp_threshold),   "20",           &low_hp_threshold,   "set HP threshold that triggers warning.");
}
