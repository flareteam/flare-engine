	...
	, safe_video(false)
{
	...
	setConfigDefault(39, "item_compare_tips",   &typeid(item_compare_tips),   "1",             &item_compare_tips,   "Show comparison tooltips for equipped items of the same type | 0 = disable, 1 = enable");
